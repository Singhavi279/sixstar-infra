...
export const FeatureCard = ({id}) => {
    return (
        <div className="container my-5 py-2" id={id}>
            ...
            <div className="row">
                <div data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000" data-aos-once="false" className="col-md-4 text-center py-4 mt-5">
                ...
                <div data-aos="fade-up" data-aos-duration="1000" data-aos-once="false" className="col-md-4 text-center py-4 mt-5 rounded" id="price-table__premium">
                    ...
                    <a href="#" className="btn my-4 font-weight-bold atlas-cta cta-blue">Get Free</a>
                </div>
                <div data-aos="fade-left" data-aos-delay="200" data-aos-duration="1000" data-aos-once="false" className="col-md-4 text-center py-4 mt-5">
